package eu.vdmr.dspgui.component.analyzer.counter;
...
import eu.vdmr.dspgui.util.project.component.analyzer.ZeroCrossingCounterFiler;

public class ZeroCrossingCounterGui extends DSPGuiComponentImpl {
	private static Logger LOG = LogManager.getLogger(ZeroCrossingCounterGui.class);
