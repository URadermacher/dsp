package eu.vdmr.dspgui.component.analyzer.transform;
...
import eu.vdmr.dsp.component.analyzer.transform.SimpleFFT;
...
import eu.vdmr.dspgui.util.project.component.analyzer.SimpleFFTFiler;

public class SimpleFFTGui extends DSPGuiComponentImpl {
    private static Logger LOG = LogManager.getLogger(SimpleFFTGui.class);
