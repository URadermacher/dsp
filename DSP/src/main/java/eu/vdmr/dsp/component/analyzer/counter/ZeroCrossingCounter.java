package eu.vdmr.dsp.component.analyzer.counter;
...
import eu.vdmr.dsp.component.analyzer.AbstractAnalyzer;
import eu.vdmr.dsp.component.data.ZeroCountDataWriter;
...
public class ZeroCrossingCounter extends AbstractAnalyzer {
	private static Logger LOG = LogManager.getLogger(ZeroCrossingCounter.class);
