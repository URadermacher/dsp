package eu.vdmr.dsp.component.io.player;
...
import eu.vdmr.dsp.util.system.Settings;
import eu.vdmr.util.bits.BBConverter;

public class WAVPlayer extends AbstractAudioSink implements Callable<ExecutionResult>{
	private static Logger LOG = LogManager.getLogger(WAVPlayer.class);
	private Mixer mixer;
