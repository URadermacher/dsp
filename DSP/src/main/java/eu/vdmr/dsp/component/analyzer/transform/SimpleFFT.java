package eu.vdmr.dsp.component.analyzer.transform;
...
import eu.vdmr.dsp.component.data.FFTDataWriter;

public class SimpleFFT extends AbstractAnalyzer {
	private static Logger LOG = LogManager.getLogger(SimpleFFT.class);
